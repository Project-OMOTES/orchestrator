...
class TimeSeriesManagerTest(unittest.TestCase):
    def test__time_series_info_is_stale_on_registered_at__returns_true(self) -> None:
        # Arrange
        ...
        # Act / Assert
        self.assertTrue(
            EsdlTimeSeriesManager.esdl_time_series_info_is_stale(
    ...
    def test__time_series_info_is_stale_on_registered__returns_false(self) -> None:
        # Arrange
        cur_time = datetime.now()
        esdl_time_series_info = EsdlTimeSeriesInfoDB()
        esdl_time_series_info.esdl_id = "id1"
    ...
    def test__time_series_info_is_stale_esdl_in_list__returns_false(self) -> None:
        # Arrange
        cur_time = datetime.now()
        esdl_time_series_info = EsdlTimeSeriesInfoDB()
        esdl_time_series_info.esdl_id = "id1"
    ...
    def test__time_series_data_is_timed_out_deactivated_at_not_set__returns_false(self) -> None:
        # Arrange
        cur_time = datetime.now()
        esdl_time_series_info = EsdlTimeSeriesInfoDB()
    ...
    def test__time_series_data_is_timed_out_on_deactivated_at__returns_true(self) -> None:
        # Arrange
        cur_time = datetime.now()
        esdl_time_series_info = EsdlTimeSeriesInfoDB()
    ...
    def test__time_series_data_is_timed_out_on_deactivated_at__returns_false(self) -> None:
        # Arrange
        cur_time = datetime.now()
        esdl_time_series_info = EsdlTimeSeriesInfoDB()
